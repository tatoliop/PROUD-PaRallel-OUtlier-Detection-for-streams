...
import utils.Utils.{PrintOutliersBinaryExplain, Query}
import utils.traits.Partitioning

import scala.collection.mutable
import scala.collection.mutable.ListBuffer

object Outlier_detection_DEBUG {
  ...
  def main(args: Array[String]) {
    ...
    env.setParallelism(detectionParallelism)
    ...
    //Output outliers
      timestampedData
        ...
        .process(new PrintOutliersBinaryExplain(subspaces))
        .print
